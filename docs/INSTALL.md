...
The DOTA images and labels have to be splitted using the code in [here](https://github.com/CAPTAIN-WHU/DOTA_devkit). The DOTA annotations should be converted into the coco format using the scripts in DOTA_devkit/DOTA2COCO.py.
