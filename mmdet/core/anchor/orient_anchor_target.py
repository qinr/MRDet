...
from ..bbox import (PseudoSampler, assign_and_sample, bbox2delta, build_assigner,
                    delta2hbboxrec5, hbbox2rbboxRec_v2, rbboxPoly2Rectangle_v2,
                    rec2target_v1, rec2delta_v2)
...
def orient_anchor_target_single(bbox_pred,
    ...
    if len(pos_inds) > 0:
        ...
        pos_obb_targets = rec2target_v1(pos_bbox_rec, pos_gt_rbboxes_rec,
...
def orient_anchor_target_v1(anchor_list,
                         valid_flag_list,
                         gt_bboxes_list,
                         gt_rbboxes_poly_list,
                         img_metas,
    ...
    (all_labels, all_label_weights, all_bbox_targets, all_bbox_weights,
     pos_inds_list, neg_inds_list) = multi_apply(
         orient_anchor_target_v1_single,
         anchor_list,
         valid_flag_list,
         gt_bboxes_list,
         gt_rbboxes_poly_list,
...
def orient_anchor_target_v1_single(flat_anchors,
                                valid_flags,
                                gt_bboxes,
                                gt_rbboxes_poly,
                                gt_bboxes_ignore,
    ...
    neg_inds = sampling_result.neg_inds # 负样本索引
    if len(pos_inds) > 0:
        pos_bboxes_rec = hbbox2rbboxRec_v2(sampling_result.pos_bboxes)
        pos_assigned_gt_inds = sampling_result.pos_assigned_gt_inds
        pos_gt_rbboxes_poly = gt_rbboxes_poly[pos_assigned_gt_inds]
        pos_gt_rbboxes_rec = rbboxPoly2Rectangle_v2(pos_gt_rbboxes_poly)
        pos_bbox_targets = rec2delta_v2(pos_bboxes_rec,
                                      pos_gt_rbboxes_rec,
