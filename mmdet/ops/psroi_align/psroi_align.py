...
class PSRoIAlignFunction(Function):
    ...
    def forward(ctx, features, rois, pooled_size, spatial_scale, group_size, sample_num=0):
        ...
        psroi_align_cuda.forward(features, rois, pooled_height, pooled_width,
    ...
    def backward(ctx, grad_output):
        ...
        if ctx.needs_input_grad[0]:
            ...
            psroi_align_cuda.backward(grad_output, rois, mapping_channel,
...
psroi_align = PSRoIAlignFunction.apply
...
class PSRoIAlign(nn.Module):
    ...
    def forward(self, features, rois):
        return psroi_align(features, rois, self.pooled_size, self.spatial_scale,
