...
int psroi_align_forward_cuda(at::Tensor features, at::Tensor rois,
  ...
  PSROIAlignForwardLauncher(features, rois, spatial_scale, sample_num, in_channels,
...
int psroi_align_backward_cuda(at::Tensor top_grad, at::Tensor rois,
  ...
  PSROIAlignBackwardLauncher(top_grad, rois, mapping_channel, spatial_scale, sample_num,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("backward", &psroi_align_backward_cuda,
        "PSRoi_align backward (CUDA)");
}
