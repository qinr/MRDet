...
template <typename scalar_t>
__global__ void RROIAlignForward(const int nthreads, const scalar_t *bottom_data,
...
int RROIAlignForwardLaucher(const at::Tensor features, const at::Tensor rois,
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(
        features.type(), "RROIAlignLaucherForward", ([&] {
            const scalar_t *bottom_data = features.data<scalar_t>();
            const scalar_t *rois_data = rois.data<scalar_t>();
            scalar_t *top_data = output.data<scalar_t>();
            
            RROIAlignForward<scalar_t>
...
int RROIAlignBackwardLaucher(const at::Tensor top_grad, const at::Tensor rois,
    ...
    at::Tensor bottom_grad) {
        const int output_size = num_rois * pooled_height * pooled_width * channels;
        AT_DISPATCH_FLOATING_TYPES_AND_HALF(
            top_grad.type(), "RROIAlignLaucherBackward", ([&] {
