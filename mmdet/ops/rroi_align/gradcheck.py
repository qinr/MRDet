...
from rroi_align import RRoIAlign  # noqa: E402
...
class test_op_roi_align_rotated(unittest.TestCase):
    ...
    def test_roi_align_rotated_value(self):
        ...
        roialign_rotated = RRoIAlign(out_size=2, spatial_scale=1, sample_num=0)
    ...
    def test_roi_align_rotated_autograd(self):
        ...
        spatial_scale = 1
        test = gradcheck(RRoIAlign(4, spatial_scale), inputs, atol=1e-3, eps=1e-3)
        print(test)
        test = gradcheck(RRoIAlign(4, spatial_scale, 2), inputs, atol=1e-3, eps=1e-3)
        print(test)
