...
class DOTADatasetVOC(XMLDataset):
    ...
    def __init__(self, **kwargs):
        super(DOTADatasetVOC, self).__init__(**kwargs)
    ...
    def get_ann_info(self, idx):
        ...
        for obj in root.findall('object'):
            ...
            label = self.cat2label[name] # label从1开始，0表示背景类
        ...
        if not bboxes:
            ...
            bboxes = np.array(bboxes, ndmin=2) - 1 # 这里-1对于DOTA数据集会出现问题么
...
@DATASETS.register_module
class DOTADatasetCocoH(CocoDataset):
    CLASSES = ('plane', 'baseball-diamond', 'bridge', 'ground-track-field',
               'small-vehicle', 'large-vehicle', 'ship',
               'tennis-court', 'basketball-court',
               'storage-tank', 'soccer-ball-field',
    ...
    def __init__(self, **kwargs):
        super(DOTADatasetCocoH, self).__init__(**kwargs)
