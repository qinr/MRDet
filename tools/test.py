...
def single_gpu_test(model, data_loader, show=False, show_dir=None):
    ...
    for i, data in enumerate(data_loader):
        ...
        if show:
            model.module.show_result(data, result, show_dir=show_dir)
...
def main():
    ...
    if not distributed:
        ...
        show_dir = os.path.join(os.path.split(args.out)[0], 'images')
        outputs = single_gpu_test(model, data_loader, args.show, show_dir)
