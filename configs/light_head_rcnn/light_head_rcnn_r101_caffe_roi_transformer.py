...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.001, nms=dict(type='poly_nms', iou_thr=0.1), max_per_img=1000)
# soft-nms is also supported for rcnn testing
    # e.g., nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.05)
)
# dataset settings
# dataset_type = 'CocoDataset'
dataset_type = 'DOTADatasetVOC'
# data_root = '/data/qrrr/mmdetection/data/coco/'
data_root = '/data/qrrr/mmdetection/data/DOTA/'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='RandomFlip', flip_ratio=0),  # 随机翻转，flip_ratio表示翻转可能性
