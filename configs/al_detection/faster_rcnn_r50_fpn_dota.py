...
train_pipeline = [
    ...
    dict(type='Resize', resize_ratio=1, img_scale=(1024, 1024), keep_ratio=True),  # 输入图像尺寸，最大边1333，最小边800，keep_ratio：是否保持原图的长宽比
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'trainval1024/DOTA_trainval1024_7.json',
    ...
    val=dict(
        ...
        ann_file=data_root + 'test1024/debug.json',
...
log_level = 'INFO'
work_dir = './work_dirs/al_detection/faster_rcnn_r50_fpn_dota/7_coco/'
# load_from = None
load_from = './checkpoints/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15_classes_16.pth'
resume_from = None
workflow = [('train', 1)]
