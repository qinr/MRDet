...
def HRSC2COCOTrain(srcpath, destfile, cls_names, train_set_file):
    ...
    labelparent = os.path.join(srcpath, 'FullDataSet', 'Annotations_dota')
...
def HRSC2COCOTest(srcpath, destfile, cls_names, test_set_file):
    imageparent = os.path.join(srcpath, 'Test', 'AllImages')
...
if __name__ == '__main__':
    ...
    # HRSC2COCOTrain(r'/home/qinran_2020/data/HRSC2016',
    #                r'/home/qinran_2020/data/HRSC2016/ImageSets/trainval.json',
    #                L1_names,
    #                r'/home/qinran_2020/data/HRSC2016/ImageSets/trainval.txt')
    HRSC2COCOTest(r'/home/qinran_2020/data/HRSC2016',
                  r'/home/qinran_2020/data/HRSC2016/ImageSets/test.json',
                  L1_names,
                  r'/home/qinran_2020/data/HRSC2016/ImageSets/test.txt')
