...
def main():
    ...
    detpath = r'/home/qinran_2020/mmdetection/eval/dh_faster_rcnn_hbb_obb_transformer_4_branch_r101_fpn_2x_hrsc2016/2020070412/L1_results/L1_results_{:s}.txt'
    ...
    annopath = r'/home/qinran_2020/mmdetection/data/HRSC2016/Test/Annotations_dota/{:s}.txt'
    # imagesetfile = r'PATH_TO_BE_CONFIGURED/valset.txt'
    imagesetfile = r'/home/qinran_2020/mmdetection/data/HRSC2016/ImageSets/test.txt'
    # from IPython import embed
    # embed()
